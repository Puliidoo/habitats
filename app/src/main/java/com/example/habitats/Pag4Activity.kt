...
class Pag4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ImageView>(R.id.avatar2).setOnClickListener {
            ...
            mark2.setImageResource(R.drawable.tick)
            mark2.visibility = ImageView.VISIBLE
            ...
            if (!puntosSumados) {
                ...
                val intent = Intent(this, Pag5Activity::class.java)
        ...
        findViewById<ImageView>(R.id.avatar3).setOnClickListener {
            mostrarIncorrectoYPenalizar(mark3, mark1, mark2, mark3)
        }
